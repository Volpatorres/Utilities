@echo off
:: Batch script to add "Open with Code" to context menu
:: Check and elevates to Admin if needed
...
:: Restart File Explorer to ensure changes
